...
mol_freq_list = [6.5]
pzt_para_list = [5.5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10]
probe_att_list = [0.3,0.6,0.9] # actaully this is cav_odt_list
cav_odt_att_list = probe_att_list
...
num_frames = len(pzt_para_list) + 1
