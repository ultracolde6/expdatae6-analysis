...
tweezer_freq_list = [110,116] #(110 is fake)
num_tweezers = len(tweezer_freq_list)
num_frames = len(mol_freq_list) + 2
run_doc_string = ('questionale run - molasses intensity lock is sometimes lower than setpoint value.'
