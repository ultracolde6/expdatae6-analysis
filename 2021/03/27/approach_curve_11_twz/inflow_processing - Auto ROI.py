...
run_name = 'approach_curve_11_twz'
num_shots = 9000
save_fit_plot = False
save_ROI_plot = False
...
tweezer_00_vert_center_init = 68# starting position of tweezer 0 = 108MHz
tweezer_00_horiz_center_init = 21
...
for point in range(num_points):
    ...
    for tweezer in range(num_tweezers):
        ...
        for frame_num in range(len(mol_freq_list)):
            ...
            x_centerpos_4[tweezer, tweezer_att_counter, mol_att_counter,frame_num] = tweezer_00_horiz_center_init + tweezer * tweezer_horiz_spacing_init + x0 - tweezer_horiz_span_init / 2
            y_centerpos_4[tweezer, tweezer_att_counter, mol_att_counter,frame_num] = tweezer_00_vert_center_init + tweezer * tweezer_vert_spacing_init + y0 - tweezer_vert_span_init / 2
        ...
        x_centerpos_3[tweezer,tweezer_att_counter,mol_att_counter] = tweezer_00_horiz_center_init + tweezer*tweezer_horiz_spacing_init +  x0 - tweezer_horiz_span_init/2
        y_centerpos_3[tweezer,tweezer_att_counter,mol_att_counter] = tweezer_00_vert_center_init + tweezer*tweezer_vert_spacing_init + y0 - tweezer_vert_span_init/2
...
for tweezer in range(num_tweezers):
    for tweezer_att_counter in range(len(tweezer_att_list)):
        for mol_freq_counter in range(len(mol_freq_list)):
            ...
            x0, y0 = [fit_struct['x0']['val'], fit_struct['y0']['val']]
            sx, sy = [fit_struct['sx']['val'], fit_struct['sy']['val']]
            x_centerpos_frame[tweezer, tweezer_att_counter, mol_freq_counter] = tweezer_00_horiz_center_init + tweezer * tweezer_horiz_spacing_init + x0 - tweezer_horiz_span_init / 2
            y_centerpos_frame[tweezer, tweezer_att_counter, mol_freq_counter] = tweezer_00_vert_center_init + tweezer * tweezer_vert_spacing_init + y0 - tweezer_vert_span_init / 2
    ...
    x0, y0 = [fit_struct['x0']['val'], fit_struct['y0']['val']]
    sx, sy = [fit_struct['sx']['val'], fit_struct['sy']['val']]
    x_centerpos_1[tweezer] = tweezer_00_horiz_center_init + tweezer*tweezer_horiz_spacing_init +  x0 - tweezer_horiz_span_init/2
    y_centerpos_1[tweezer] = tweezer_00_vert_center_init + tweezer*tweezer_vert_spacing_init + y0 - tweezer_vert_span_init/2
    ...
    for tweezer_att_counter in range(len(tweezer_att_list)):
        for inner_counter in range(num_inner_loop):
            x_centerpos[tweezer, tweezer_att_counter*num_inner_loop+inner_counter] = tweezer_00_horiz_center_init + tweezer * tweezer_horiz_spacing_init + x0 - tweezer_horiz_span_init / 2
            y_centerpos[tweezer, tweezer_att_counter*num_inner_loop+inner_counter] = tweezer_00_vert_center_init + tweezer * tweezer_vert_spacing_init + y0 - tweezer_vert_span_init / 2
