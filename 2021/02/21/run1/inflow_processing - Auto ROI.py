...
mol_freq_list = [4.5,5,5.5,6,6.5,7,7.5,8,9.5,9]
pzt_para_list = [5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10]
# in this case probe_att_list is actually cav_odt_att_list
probe_att_list = [0.2,0.4,0.6,0.8,1]
cav_odt_att_list = [0.2,0.4,0.6,0.8,1]
...
for point in range(num_points):
    ...
    for tweezer in range(num_tweezers):
        ...
        print(
            ...
            f" - x0={x0:.03f},y0={y0:.03f},sx={sx:.03f},sy={sy:.03f}")
if save_ROI_plot:
    fig.savefig('tweezers_raw_data',dpi=200)
for tweezer in range(num_tweezers):
